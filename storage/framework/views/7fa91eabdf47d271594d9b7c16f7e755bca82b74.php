            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $tabel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e(date('d M Y', strtotime($item->tanggal))); ?></td>
                      <td><?php echo e($item->uang_masuk); ?></td>
                      <td><?php echo e($item->uang_keluar); ?></td>
                    </tr>
